...
if (!defined('APP_SESSION_IDLE_TIMEOUT')) {
    define('APP_SESSION_IDLE_TIMEOUT', getenv('APP_SESSION_IDLE_TIMEOUT') ?: '15552000');
}

if (!defined('APP_SESSION_ABSOLUTE_TIMEOUT')) {
    define('APP_SESSION_ABSOLUTE_TIMEOUT', getenv('APP_SESSION_ABSOLUTE_TIMEOUT') ?: '31536000');
}

if (!defined('APP_SESSION_COOKIE_LIFETIME')) {
    define('APP_SESSION_COOKIE_LIFETIME', getenv('APP_SESSION_COOKIE_LIFETIME') ?: APP_SESSION_IDLE_TIMEOUT);
}
