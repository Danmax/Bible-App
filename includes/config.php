...
if (!defined('APP_SESSION_IDLE_TIMEOUT')) {
    define('APP_SESSION_IDLE_TIMEOUT', getenv('APP_SESSION_IDLE_TIMEOUT') ?: '2592000');
}

if (!defined('APP_SESSION_ABSOLUTE_TIMEOUT')) {
    define('APP_SESSION_ABSOLUTE_TIMEOUT', getenv('APP_SESSION_ABSOLUTE_TIMEOUT') ?: '7776000');
}
